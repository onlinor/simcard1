...
namespace SimCard.API.Persistence.Repositories
{
    public class EmailRepository : IEmailRepository
    {
        ...
        public async Task<List<Event>> GetListEventActive()
        {
            ...
            List<Event> dsEvent = await context.Events.ToListAsync();
            ...
            foreach (Event item in dsEvent)
            {
                ...
                {
                    Event eventUpdate = context.Events.Find(item.Id);
        ...
        {
            List<Customer> dsCustomer = await context.Customers.ToListAsync();
