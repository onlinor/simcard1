...
export class EventsComponent implements OnInit, OnDestroy {
  ...
  toastUpdateEventSuccess() {
    this.messageService.add({
      severity: 'success',
      detail: 'Cập nhật trạng thái sự kiện'
    });
  }
  ...
  onDeleteEvent() {
    this.subscription = this.eventService
      .deleteEvent(this.idSelectedEvent)
      .subscribe(
        () => {
          this.toastSuccess();
          this.getAllEvent();
  ...
  onActiveEvent() {
    ...
    this.subscription = this.eventService
      .updateStatusEvent(this.idSelectedEvent, this.eventUpdate)
      .subscribe(
        () => {
  ...
  onSubmit() {
    ...
    if (this.newEvent) {
      ...
      this.subscription = this.eventService
        .updateEvent(this.idSelectedEvent, this.eventUpdate)
        .subscribe(
          () => {
            this.toastSuccess();
            this.getAllEvent();
