        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenKhachHang = table.Column<string>(maxLength: 255, nullable: true),
                    MaKhachHang = table.Column<string>(maxLength: 255, nullable: true),
                    SoPhieu = table.Column<string>(maxLength: 255, nullable: true),
                    NoiDungPhieu = table.Column<string>(maxLength: 255, nullable: true),
                    NoKhach = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    KhachNo = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CongDon = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Debtbook", x => x.Id);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2019, 5, 4, 15, 54, 1, 440, DateTimeKind.Local).AddTicks(3412), null, "Galvin", "Nguyen", "LQ9q7Ev5+P6J01vc8TZacjKrW7s2wtxxSyLck5fmbx8=", "izyFlFycmCKH8zCivw/WIQ==", "Company", null, "company" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "DateCreated", "DateModified", "FirstName", "LastName", "Password", "PasswordSalt", "Role", "ShopId", "Username" },
                values: new object[] { 2, new DateTime(2019, 5, 4, 15, 54, 1, 450, DateTimeKind.Local).AddTicks(6712), null, "Galvin", "Nguyen", "LQ9q7Ev5+P6J01vc8TZacjKrW7s2wtxxSyLck5fmbx8=", "izyFlFycmCKH8zCivw/WIQ==", "Branch", null, "branch" });
