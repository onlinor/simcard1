...
namespace SimCard.APP.Controllers
{
    ...
    {
        private readonly ExportReceiptRepository _exportReceiptRepository;
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public ExportReceiptController(ExportReceiptRepository exportReceiptRepository, IUnitOfWork unitOfWork, IMapper mapper)
        {
